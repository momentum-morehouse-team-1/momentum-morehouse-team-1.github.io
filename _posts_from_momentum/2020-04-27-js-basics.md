...
[Link to the assignment - this one is not on GitHub, nothing to turn in](https://earsketch.gatech.edu/earsketch2/#?curriculum=8-0-0&language=javascript) Select JS as the language, and complete Unit 1.
